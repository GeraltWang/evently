						...
						render={({ field }) => (
							<FormItem className=' w-full'>
								...
								<FormControl className=' h-72'>
									<Textarea className=' textarea rounded-2xl' placeholder='Event Description' {...field} />
								</FormControl>
								<FormMessage />
							</FormItem>
						)}
					...
					<FormField
						...
						render={({ field }) => (
							<FormItem className=' w-full'>
								{/* <FormLabel>Title</FormLabel> */}
								<FormControl className=' h-72'>
									<FileUploader onFileChange={field.onChange} imageUrl={field.value} setFiles={setFiles} />
								</FormControl>
								<FormMessage />
							</FormItem>
						)}
							...
							<FormItem className=' w-full'>
								<FormControl>
									<div className=' flex-center h-[54px] w-full overflow-hidden rounded-full bg-gray-50 px-4 py-2'>
										<Image src={'/assets/icons/location-grey.svg'} alt='location' width={24} height={24}></Image>
